...
if __name__ == "__main__":
    save_path = r"model_saver\AE_FC_KL_Kel9_Kmeans"
    out_dir_prefix = os.path.join(save_path, "model")
    height = 28
    width = 28
    epochs = 50
    ...
    #print(temp.shape)
    ae.train_AE_kmeans(input_mnist,label_mnist, GPU_ratio=GPU_ratio, epochs=epochs, fine_tune=False)
    # print("AI訓練結束")